...
export class CreateUserTable1758615434203 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "product_category_category" ("productId" uuid NOT NULL, "categoryId" uuid NOT NULL, CONSTRAINT "PK_f4340e51cf15d253111ae3bc5da" PRIMARY KEY ("productId", "categoryId"))`);
